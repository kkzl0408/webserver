...
// 网站的根目录
const char* doc_root = "/home/kzl/webserver/resources";
...
bool http_conn::read()
{
    ...
    while(true)
    {
        //m_read_buf + m_read_idx含义：数组首地址+偏移量
